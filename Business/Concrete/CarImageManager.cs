...
namespace Business.Concrete
{
    public class CarImageManager : ICarImageService
    {
        ...
        public IResult GetAllImagesByCarId(int id)
        {
            return new SuccessDataResult<List<CarImage>>(CheckIfDefaultImages(id));
        }

        private List<CarImage> CheckIfDefaultImages(int id)
        {
            var DefaultPath = AppDomain.CurrentDomain.BaseDirectory + "C:\\Users\nurcan\\Desktop\\c#\\CarRental\\ReCapProject-master (12)\\ReCapProject-master\\WebAPI\\Images\\CarImages\\4632823a-ae89-47cd-89e5-7aaca86e844d_6_4_2021.jpg";
